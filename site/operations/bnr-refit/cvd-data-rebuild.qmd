---
title: "CVD Dataset rebuild 2025"
description: "Our Data Preparation Process"
keywords:
  - BNR
...
::: {.callout-note title="CVD Dataset re-creation: details" collapse="true"}
...
::: {.callout-note title="Case Example 1: Tracing Missing Identifiers in Historical BNR Datasets" collapse="true"}
...
::: {.callout-note title="Case Example 2: Duplicate Datasets in the BNR Document Repository" collapse="true"}
...
![Distribution of duplicate dataset filenames in the DM/ directory](../../downloads/files/briefings/cvd_forensics_2025_v1/figures/cvd_file_instances.png)  
