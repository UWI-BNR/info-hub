---
title: "Dataset dissemination procedure"
subtitle: "BNR Operations Manual | Dataset dissemination"
description: "BNR Operations Manual | Dataset dissemination"
date: 2026-08-11
...
This procedure governs dissemination of datasets produced by the BNR. It defines the datasets eligible for dissemination, required approvals and safeguards, and how these align with national legislation including the Barbados Data Protection Act (2019). It also establishes principles for public access, academic use and internal control.


## 2. Scope

This procedure applies to all stakeholders involved in sharing, accessing and reusing BNR data. It covers data derived from CVD registry operations, including acute myocardial infarction and stroke datasets.
...
**Data Access Manager**  
{{< fa envelope >}} datarequests@bnr.org.bb

## 11. Review Cycle

- Procedure reviewed every 12 months or sooner if legislation or BNR policy changes.
