---
title: "Dataset release procedure"
subtitle: "BNR Operations Manual | Continuous Dataset Release and Tiered Access"
description: "BNR Operations Manual |Continuous Dataset Release and Tiered Access"
date: 2026-08-11
...
# Continuous Dataset Release and Tiered Access
...
## 2. Scope
This procedure applies to all personnel involved in BNR data processing, analysis and dissemination related to cardiovascular diseases (AMI and stroke).
...
See metadata standards (add link) for details: 
...
### 7.2. De-identified Dataset {#de-identify}
...
### 7.3. Anonymised Dataset {#anonymize}
...
## 8. Identifiability Risk {#identifiability}
...
- Procedure reviewed annually or after major system or policy changes
