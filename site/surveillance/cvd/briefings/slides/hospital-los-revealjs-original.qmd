...
Length of hospital stay links CVD surveillance to service planning.

::: {.number-grid}
::: {.number-card}
<div class="large-number">Median</div>
<div class="label">typical length of stay</div>
:::

::: {.number-card}
<div class="large-number">2010-2023</div>
<div class="label">surveillance period</div>
:::

::: {.number-card}
<div class="large-number">2014</div>
<div class="label">baseline for extra bed-days</div>
:::

::: {.number-card}
<div class="large-number">Stroke + AMI</div>
<div class="label">hospital events included</div>
:::
:::

::: {.insight-box}
A longer typical stay can create bed pressure even when event counts change only modestly.
:::
