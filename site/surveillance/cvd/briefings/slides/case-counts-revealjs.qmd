...
format:
  revealjs:
    output-file: bnr_cvd_cases_2023_v2_slides.html
    theme: simple
    width: 1600
    height: 900
    margin: 0.06
...
::: {.insight-box}
The monthly chart combines stroke and heart attack cases, avoiding publication of the former weekly series while retaining a clear view of change over time.
:::
...
- We compared the cumulative monthly departure of stroke and heart attack cases during 2022 and 2023.
- We used the 2018–2022 average for each event type and calendar month as a recent comparator.

## Cumulative difference in <span class="stroke">stroke</span> and <span class="heart">heart attack</span> cases, 2022–2023

::: {.columns}
::: {.column width="68%"}
![](../../../../downloads/files/briefings/cvd_cases_2023_v2/figures/cvd_cases_monthly.png){fig-alt="Separate cumulative differences for stroke and heart attack cases in 2022 and 2023, each compared with the 2018 to 2022 event-specific calendar-month average."}
:::

::: {.column width="32%"}
### Main pattern

- The two 24-month series show the accumulated monthly departure from their event-specific expected patterns without exposing weekly counts.
- Each comparator uses the average for the same event type and calendar months during 2018–2022.
- Monthly movements should be interpreted as surveillance signals, not incidence rates.
...
::: {.columns}
::: {.column width="68%"}
![](../../../../downloads/files/briefings/cvd_cases_2023_v2/figures/cvd_cases_age_group.png){fig-alt="Age distribution of hospital-registered stroke and heart attack cases."}
:::
