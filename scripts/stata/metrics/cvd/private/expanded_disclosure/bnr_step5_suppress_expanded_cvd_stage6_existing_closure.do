...
display as result "Running expanded CVD Step 5 Stage 6 existing-closure helper v0.7.0"
...
local required_variables metric_id release_id primary_suppression related_primary_cells related_suppression_review suppression_review stage5_structural_secondary
...
replace detail = "Existing burden decisions are reused rather than recalculated." in 1
