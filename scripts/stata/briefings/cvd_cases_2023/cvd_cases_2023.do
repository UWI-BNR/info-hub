...
file write `downloads_yml' "  Cases in Barbados" _n
file write `downloads_yml' "" _n

file write `downloads_yml' "description: |-" _n
file write `downloads_yml' "  Public aggregate output package for the BNR CVD case-count briefing." _n
file write `downloads_yml' "" _n

file write `downloads_yml' "briefing_page: surveillance/cvd/briefings/case-counts.qmd" _n
file write `downloads_yml' "" _n
...
file write `downloads_yml' "    title: Weekly case-count dataset" _n
...
file write `downloads_yml' "    title: Weekly case-count dataset, Stata format" _n
file write `downloads_yml' "    artefact_type: Dataset" _n
...
file write `downloads_yml' "    description: |-" _n
file write `downloads_yml' "      Stata dataset version of the weekly CVD case-count data, including labels and dataset notes." _n
file write `downloads_yml' "    include_in_listing: true" _n
file write `downloads_yml' "    sort_order: 50" _n

* Weekly cases metadata
file write `downloads_yml' "  - id: `output1'_metadata" _n
file write `downloads_yml' "    title: Weekly case-count metadata" _n
...
file write `downloads_yml' "    description: |-" _n
file write `downloads_yml' "      Figure showing cumulative 2023 hospital CVD cases compared with the 2018-2022 baseline average." _n
file write `downloads_yml' "    include_in_listing: true" _n
file write `downloads_yml' "    sort_order: 100" _n

* Age-group figure
file write `downloads_yml' "  - id: `output2'_figure" _n
file write `downloads_yml' "    title: Case-count age-group figure" _n
file write `downloads_yml' "    artefact_type: Figure" _n
file write `downloads_yml' "    format: PNG" _n
file write `downloads_yml' "    file: figures/`output2'.png" _n
file write `downloads_yml' "    href: `site_base'/figures/`output2'.png" _n
file write `downloads_yml' "    description: |-" _n
file write `downloads_yml' "      Figure showing the broad age-group distribution of 2023 hospital CVD cases compared with the 2018-2022 baseline average." _n
file write `downloads_yml' "    include_in_listing: true" _n
...
file write `downloads_yml' "    description: |-" _n
file write `downloads_yml' "      Briefing-level metadata describing the public CVD case-count output package." _n
file write `downloads_yml' "    include_in_listing: true" _n
