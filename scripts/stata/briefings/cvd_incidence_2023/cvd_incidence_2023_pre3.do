...
* This first pilot reproduces the established 2023 briefing from the legacy
* preparation script. These fields record that source honestly in the staging
* metadata. A later controlled change will move the briefing to Step 3 input.
local input_dataset_id  "bnrcvd_prep_2023_v1"
local input_release     "December 2023 cumulative"
local input_coverage    "2023-12-31"
