...
VERSION: 1.1.0 (3 September 2026)
...
local annual_event_counts_interpretation ///
...
local annual_event_rates_interpretation ///
...
local annual_event_type_interpretation ///
...
local annual_event_sex_interpretation ///
...
local annual_event_age_interpretation ///
...
* Backward-compatible umbrella local retained for the current standard file.
local annual_events_interpretation ///
    "`annual_event_counts_interpretation'"

* -----------------------------------------------------------------------------
* CVD mortality
* -----------------------------------------------------------------------------

local annual_mortality_counts_interpretation ///
...
local annual_mortality_rates_interpretation ///
...
local annual_mortality_type_interpretation ///
...
local annual_mortality_sex_interpretation ///
...
local annual_mortality_age_interpretation ///
...
local annual_mortality_interpretation ///
    "`annual_mortality_counts_interpretation'"

* -----------------------------------------------------------------------------
* How complete is the picture?
* -----------------------------------------------------------------------------

local annual_event_quality_interpretation ///
...
local annual_mortality_quality_interpretation ///
