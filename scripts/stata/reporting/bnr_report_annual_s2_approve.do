...
*******************************************************************************
* BNR ANALYST GUIDE - INVARIANT APPROVAL CONTROLLER
*
* BNR ANALYST: DO NOT EDIT THIS FILE during routine report production.
* Step 2 records a human decision about the fixed Step 1 candidate. It does not
* rebuild the PDF, alter its contents or publish anything. The shared approval
* helper verifies the candidate and writes the approval receipt and manifested
* public-ready payload. Changing this code can weaken approval immutability.
*******************************************************************************
...
* Read and validate the report identity, named approver, role and three explicit
* confirmation words. Approval deliberately has no replace pathway.
...
* INVARIANT - DO NOT EDIT.
* Load configured roots and stop if the private approval environment is absent.
if "$BNR_STATA" == "" {
...
* INVARIANT - DO NOT EDIT.
* Require the candidate package and prepare only its public-ready subdirectory.
...
* Delegate candidate validation, checksums, confirmations and receipt creation
* to the shared controlled approval helper. Any non-zero return stops safely.
...
* INVARIANT - DO NOT EDIT.
* Print the approval receipt locations and reiterate that publication has not
* yet occurred.
quietly {
